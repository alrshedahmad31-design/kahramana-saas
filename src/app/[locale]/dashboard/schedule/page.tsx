...
function getMondayOf(date: Date): string {
  ...
  const day = d.getDay()
  const diff = day === 0 ? -6 : 1 - day  // Monday = 1, adjust Sunday
...
export default function SchedulePage() {
  ...
  const pendingLeaves = 0  // could fetch here later
  ...
  return (
    <div className="flex flex-col gap-5" dir={isAr ? 'rtl' : 'ltr'}>
      ...
      <div className="flex items-center justify-between gap-4">
        <div>
          <h1 className={`font-satoshi font-black text-2xl text-brand-text ${isAr ? 'font-almarai' : ''}`}>
