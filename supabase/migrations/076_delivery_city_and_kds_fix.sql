-- ============================================================
-- Kahramana Baghdad
-- Migration: 076_delivery_city_and_kds_fix.sql
-- 1. Add delivery_city column to orders
-- 2. Fix KDS trigger: id → slug lookup
-- ============================================================

-- 1. Add delivery_city column to orders table
ALTER TABLE orders
ADD COLUMN IF NOT EXISTS delivery_city TEXT;

-- 2. Fix the KDS station trigger — it was comparing UUID id with slug string
...
-- Re-attach trigger (DROP + CREATE ensures the fixed function is active)
...
-- 3. Add p_delivery_city to rpc_create_order
-- Drop the old overload (exact signature from 073) then recreate with city param
...
REVOKE EXECUTE ON FUNCTION rpc_create_order(
  TEXT, TEXT, TEXT, TEXT, TEXT, JSONB, NUMERIC,
  TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, NUMERIC, NUMERIC, TEXT,
  UUID, NUMERIC, INT, TEXT, TEXT, NUMERIC, TIMESTAMPTZ, UUID
) FROM PUBLIC;
